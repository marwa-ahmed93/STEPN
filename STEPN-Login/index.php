    ...
    <div class="main">
        ...
        <div class="container b-container" id="b-container">
            ...
            <form class="form" id="b-form" method="post" action="handellogin.php">
                <h2 class="form_title title">STEPN تسجيل الدخول فى </h2>
...
<!--                  <a class="btn btn-success" href="../STEPN-Login/index.html">تسجيل دخول</a>-->
            </form>
        </div>
...
<!--                <a class="switch__button button switch-btn" href="../STEPN-User/users.php">تسجيل دخول</a>-->
<!--                   <button class="form__button button submit">تسجيل دخول</button>-->
                <button type="submit" class="switch__button button switch-btn">تسجيل دخول</button>
...
<!--                 <a href="../STEPN -SignUp/SignUp.php" class="btn btn-primary stretched-link">انشاء حساب جديد</a>-->
                <a class="btn btn-success" href="../STEPN -SignUp/SignUp.php">انشاء حساب جديد</a>
            </div>
        </div>
    </div>
