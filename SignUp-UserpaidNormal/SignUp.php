...
<body>
  <form id="regForm" action="handelNormalSing.php" method ="post">
  <h1> تسجيل (مستخدم عادي) جديد - STEPN</h1>
...
<!-- <p><input placeholder="الرقم القومي" oninput="this.className = ''" name="national_id"></p> -->
	...
	<!-- <label for="card">ما هو جنسك ؟</label>
	<input type="radio" id="male" name="sex" value="ذكر">
	<label for="male">ذكر</label><br>
	<input type="radio" id="female" name="sex" value="انثي">
	<label for="female">انثي</label><br>
	<input type="radio" id="other" name="sex" value="اخر">
	<label for="other">اخر</label> -->
 
<!-- // <div class="dropdown">
//   <button class="btn btn-primary dropdown-toggle " type="button" data-toggle="dropdown">ماهو جنسك ؟
...
// </div> -->
<!-- <div class="dropdown">
  <button class="btn btn-primary dropdown-toggle " type="button" data-toggle="dropdown">الحالة الاجتماعية ؟
  <span class="caret"></span></button> -->
  <!-- <ul class="dropdown-menu dropdown-menu-right">
	...
	<!-- <label for="card">الحالة الاجتماعية</label>
	<input type="radio" id="male" name="wsex" value="اعزب">
	<label for="male">اعزب</label><br>
	<input type="radio" id="female" name="wsex" value="متزوج">
	<label for="female">متزوج</label><br>
	<input type="radio" id="other" name="wsex" value="مطلق">
	<label for="other">مطلق</label>
  <input type="radio" id="other" name="wsex" value="ارمل">
	<label for="other">ارمل</label> -->
