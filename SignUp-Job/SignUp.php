...
<body>
  <form id="regForm" action="handelSignJob.php" method = "post">
  <h1> تسجيل (مسؤل) جديد - STEPN</h1>
...
<label for="sport"> ليه حابب تكون مسؤل؟  </label></p>
<input type="text" id="sport" name="cause_reason"></p>

</p>

<label for="sport">التخصص؟</label></p>
<input type="text" id="sport" name="specialization"></p>
