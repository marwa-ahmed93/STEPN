...
<a href="#" class="logo"><span>STEPN</span> Sport</a>
...
<h1>STEPN الرياضي<br>صحتك تستحق !</h1>

<div class="btn-ber">
<a href="#"><button class="btn">افتح حساب الآن</button></a>
<a href="../STEPN-Index/index.php"><button class="btn">الصفحة الرئيسية</button></a>
...
<form action="../STEPN-hospital/handelIndex2.php" method="post">
