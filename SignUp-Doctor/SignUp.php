...
<body>
  <form id="regForm" action="handeSignlDoctor.php" method = "post">
  <h1>تسجيل (طبيب) جديد - STEPN</h1>
...
// }
  ...
  <div class="tab"> بيانات شخصية
    <p><input placeholder="اسم العيادة" oninput="this.className = ''" name="wfirstname"></p>
    <p><input placeholder="اسم الطبيب" oninput="this.className = ''" name="wlastname"></p>
  </div>
