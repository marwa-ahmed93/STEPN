...
<body id="page-top" class="politics_version">
    ...
    <h3 class="fs-1"><?php echo $row['user_name']; ?></h3>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#cov1">كورونا</a>
            </li>
			<li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#cov2">التهاب الدماغ</a>
            </li>
			<li class="nav-item">
				<a class="nav-link js-scroll-trigger" href="#cov3">الورم الحليمي</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link js-scroll-trigger" href="#cov4">نقص المناعة</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link js-scroll-trigger" href="#cov5">الإنفلونزا</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link js-scroll-trigger" href="#cov6">نزلات البرد</a>
			  </li>
			<li class="nav-item">
...
?>
 <li class="nav-item">
	...
	<section id="home" class="main-banner parallaxie" style="background: url('uploads/banner-01.jpg')">
		<div class="heading ">
			<h1> الرياضي & الصحي STEPN مستشفي</h1>			
			<h3 class="cd-headline clip is-full-width">
				
				<span class="cd-words-wrapper">
					<b class="is-visible">الشباب</b>
					<b>الأطفال</b>
					<b>كبار السن</b>
					<b>الحوامل</b>
				</span>
				...
				<div class="btn-ber">
					...
					<a class="learn_btn hvr-bounce-to-top" href="../STEPN-PreventionViruses/index.php">طرق الوقاية من الفيروسات</a>
...
<!--------------------فراغ about -------------------->
  ...
  <div id="cov1" >
	<section class="about-us">
        <div class="section-header">
          <h1 class="section-heading">كورونا</h1>
  ...
  <div id="cov2" >
    <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading">التهاب الدماغ</h1>
          <div class="underline"></div>
        </div>
        <div class="services">
          <div class="service">
  ...
  <div id="cov3" >
    <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading">الورم الحليمي</h1>
          <div class="underline"></div>
        </div>
        <div class="services">
          <div class="service">
  ...
  <div id="cov4" >
    <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading">نقص المناعة</h1>
          <div class="underline"></div>
        </div>
        <div class="services">
          <div class="service">
  ...
  <div id="cov5" >
    <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading">الإنفلونزا</h1>
          <div class="underline"></div>
        </div>
        <div class="services">
          <div class="service">
  ...
  <div id="cov6" >
    <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading">نزلات البرد</h1>
          <div class="underline"></div>
        </div>
        <div class="services">
          <div class="service">
            ...
            <div class="footer-distributed">
                ...
                <div class="footer-center">
                    <p class="footer-links">
                        ...
                        <a href="#services">أنواع الفيروسات</a>
                        <a href="#">كورونا</a>
                        <a href="#">التهاب الدماع</a>
                        <a href="#">الورم الحليمي</a>
                        <a href="#">نقص المناعة</a>
                        <a href="#">الإنفلونزا</a>
						<a href="#">نزلات البرد</a>
