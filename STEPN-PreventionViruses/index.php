...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>STEPN-Prevention Of Viruses</title>  
		...
		<div class="heading ">
			...
			<h3 class="cd-headline clip is-full-width">
				...
				<div class="btn-ber">
					...
					<a class="learn_btn hvr-bounce-to-top" href="../STEPN-Viruses/index.php">أنواع الفيروسات & خطورتها</a>
