...
<body>
  <form id="regForm" action="handelSignupCompany.php" method = "post">
  <h1> تسجيل (شركة) جديدة - STEPN</h1>
...
// }
  ...
  <div class="tab"> بيانات شخصية
    <p><input placeholder="اسم الشركة" oninput="this.className = ''" name="wfirstname"></p>
