...
<body>
  <form id="regForm" action="hondelHospitalSign.php" method = "post">
  <h1> تسجيل (مستشفى) جديدة - STEPN</h1>
...
// }
  ...
  <div class="tab"> بيانات شخصية
    <p><input placeholder="اسم المستشفى" oninput="this.className = ''" name="wfirstname"></p>
