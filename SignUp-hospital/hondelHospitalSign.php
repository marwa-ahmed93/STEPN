...
{
    header('location: ../SignUp-hospital/SignUp.php');
}
...
{
    //insert data
    // $query ="INSERT INTO `client`(`hospital_name`, `hospital_owner`,
    // `user_name`, `phone`, `working_time`, `available_services`, `available_specialties`, `countery`,
...
// $query ="INSERT INTO `hospital`(`hospital_name`, `hospital_owner`,
//  `user_name`, `phone`, `working_time`, `available_services`, `available_specialties`, `countery`,
//  `governorate`, `city`, `registraion_number`, `email`, `password`)
//  VALUES ('$wfirstname','$wlastname','$wUsername',$wPhone,'$working_time','$services','$specialties',
//  '$wCountry','$governorate','$city',$registration,'$wEmail','$wpassword')
